    ...
    >
      ...
      >
        ...
        >
          ...
          {soundEngineBreakThroughDinnies.map(
            (soundEngineBreakThroughDinnie) => {
              ...
              if (soundEngineBreakThroughMaterial.level === selectedLevel) {
                return (
                  <div key={soundEngineBreakThroughMaterial.level}>
                    <p>
                      A級突破素材：{needSoundEngineBreakThroughMaterialAmount.A}
                      個
                    </p>
                    <p>
                      B級突破素材：{needSoundEngineBreakThroughMaterialAmount.B}
                      個
                    </p>
                    <p>
                      C級突破素材：{needSoundEngineBreakThroughMaterialAmount.C}
                      個
                    </p>
                  </div>
                );
